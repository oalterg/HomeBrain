...
App update vs OS upgrade vs health checker:
[`UPDATE_AND_HEALTH.md`](plans/UPDATE_AND_HEALTH.md). LAN HTTPS as names
on 443, mirroring Pangolin with `.local`: [`LAN_HTTPS.md`](plans/LAN_HTTPS.md).
Bare-metal
